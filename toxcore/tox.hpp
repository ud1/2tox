 ...
 */
typedef void tox_self_connection_status_cb(Tox *tox, unsigned connection_status, void *user_data);
 ...
 */
typedef void tox_friend_status_cb(Tox *tox, uint32_t friend_number, unsigned status, void *user_data);
 ...
 */
typedef void tox_friend_connection_status_cb(Tox *tox, uint32_t friend_number, unsigned connection_status,
        void *user_data);
 ...
 */
typedef void tox_friend_message_cb(Tox *tox, uint32_t friend_number, unsigned type, const uint8_t *message,
 ...
 */
typedef void tox_file_recv_control_cb(Tox *tox, uint32_t friend_number, uint32_t file_number, unsigned control,
                                      void *user_data);
